<x-app-layout
    ...
    <x-modal title="Hapus data sekolah" btnSubmitText="Hapus" btnSubmitType="danger" btnSubmitOnClick="deleteHandler" >
        <x-slot:body>
            Data Lokasi yang sudah terhapus tidak bisa di dikembalikan secara semula, apakah anda yakin menghapus data ini ?
        </x-slot:body>
    </x-modal>
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form id="formDelete{{$lokasi->id}}" method="POST" action="{{route('lokasi.destroy',$lokasi->id)}}">
                                            @method('DELETE')
                                            @csrf
                                        </form>
                                        <button
                                            onclick='setFormDelete("formDelete{{$lokasi->id}}")'
                                            class="btn bg-red-lt"
