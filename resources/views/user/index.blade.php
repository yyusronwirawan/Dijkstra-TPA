<x-app-layout
    ...
    <x-modal title="Hapus data pengguna" btnSubmitText="Hapus" btnSubmitType="danger" btnSubmitOnClick="deleteHandler" >
        <x-slot:body>
            Data pengguna yang sudah terhapus tidak bisa di dikembalikan secara semula, apakah anda yakin menghapus data ini ?
        </x-slot:body>
    </x-modal>
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $pengguna->getRoleNames()[0] ?? '' }}
                                    </td>
                                    <td>
                                        {{ $pengguna->email }}
                                    </td>
                                    <td class="text-end">
                                        <form id="formDelete{{$pengguna->id}}" method="POST" action="{{route('user.destroy',$pengguna->id)}}">
                                            @method('DELETE')
                                            @csrf
                                        </form>
                                        <button
                                            onclick='setFormDelete("formDelete{{$pengguna->id}}")'
                                            class="btn bg-red-lt"
